...
public class GUIOptionStandards {

	public static final String VCFFILE = "-V";
	public static final String HMMMODELFILE = "-hmm";
	public static final String OUTPUTPREFIX = "-O";
	public static final String CONTIGS = "-C";
	...
	public static final String DEPTHTHRESHOLD = "-DT";
